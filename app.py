...
from flask import Flask, reuquest, app , jsonify, url_for,render_template 
...
app = Flask(__name__)
# load our model
regmodel = pickle.load(open('regmode.pkl','rb'))
...
# we here creating a aapi to run the model, get the prediction and retur the predicted value 
